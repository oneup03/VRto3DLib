...
private:
    ...
    nlohmann::ordered_json default_config_ = {
        ...
        {"track_filter_rotation_sensitivity", 0.5},
        {"track_filter_translation_sensitivity", 0.25},
        {"track_filter_rotation_deadzone", 0.03},
        {"track_filter_translation_deadzone", 0.02},
        {"track_filter_zoom_smoothing", 0.0},
        {"track_filter_max_zoom", 10.0},
        {"launch_script", ""},
